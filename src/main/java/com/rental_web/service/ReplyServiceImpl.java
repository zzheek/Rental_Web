...
import com.rental_web.repository.ReplyRepository;
...
public class ReplyServiceImpl implements ReplyService {
    ...
    @Override
    public PageResponseDTO<ReplyDTO> getListOfRenboard(Long rennum, PageRequestDTO pageRequestDTO) {

        Pageable pageable = PageRequest.of(pageRequestDTO.getPage() <=0? 0: pageRequestDTO.getPage() -1,
                pageRequestDTO.getSize(),
                Sort.by("rno").ascending());

        Page<Reply> result = replyRepository.listOfRenboard(rennum, pageable);
